...
async def create_payment(user: User):
    ...
    description = 'Transcription of ' + str(round(info['total_length']/60.,2)) + ' minutes,' + str(info['total_files']) + ' files, email: ' + user.user_email
    ...
    add_payment_id_to_files(user.user_id, info["files"], intent['client_secret'])
    return {
